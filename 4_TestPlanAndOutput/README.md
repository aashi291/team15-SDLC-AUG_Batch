...
|   Prompt to execute the strategy either with default/External Input Values      | any input other than 1 or 2  | Invalid error message will be displayed and user will be prompted to enter a valid number  |   | Boundary|
